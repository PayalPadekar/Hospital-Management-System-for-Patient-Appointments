      ...
      <main class="col-md-9 mt-5 col-lg-10 px-md-4">
         <section class="content-header">
			<h4 class="text-center">
				...
				<span class="pagenavhead">Specialties</span>
			</h4>
		</section>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formid" enctype="multipart/form-data">
							<input type="text" class="form-control textfields d-none" id="idspecialties" name="idspecialties">
							...
							<div class="row mb-3">
                                ...
                                <div class="col-8">
                                    <input type="text" class="form-control textfields required" id="specialtiestitle" name="specialtiestitle"
                                        placeholder="Enter Specialties Title">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-4">
                                    <label>Specialties Description</label>
                                </div>
                                <div class="col-8">
                                    <textarea class="form-control textfields required" id="specialtiesdesc" name="specialtiesdesc"
                                        placeholder="Enter Specialties Description" rows="6"></textarea> 
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-8">
                                    <input type="file" class="form-control textfields" id="specialtiesimg" name="specialtiesimg">
                                    <input type="text" class="form-control d-none textfields" id="specialtiesimg_old"
                                        name="specialtiesimg_old">
                                    <img src="" class="img img-responsive d-none specialtiesimg" width="100px" height="50px">
                                </div>
                            </div>
