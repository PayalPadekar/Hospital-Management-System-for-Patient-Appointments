	...
	<table id="dttable" class="table table-bordered table-hover">
		<thead>
			<tr style='background-color:#3c8dbc;color:white;'>
				...
				<th class="text-center">Specialties Title</th>
 				<th class="text-center">Specialties Description</th>
				<th class="text-center">Specialties Image</th>
		...
		<tbody>
		<?php
			$sql = "select * from tblspecialties";
			...
			while($row = mysqli_fetch_assoc($res)){
				...
				<tr>
					...
					<td><?php echo $row['specialtiestitle']; ?></td>
                    <td><?php echo $row['specialtiesdesc']; ?></td>
                    
					
					<td class='text-center'>
						<img src="<?php echo $row['specialtiesimg']; ?>" class="img img-responsive" width="100px" height="50px">
					</td>
					<td class='text-center'>
